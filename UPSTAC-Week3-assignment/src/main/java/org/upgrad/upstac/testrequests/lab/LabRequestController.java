...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        // Implementing this method to return the list of test requests assigned to current tester(make use of the above created User object)
        // Making use of the findByTester() method from testRequestQueryService class
